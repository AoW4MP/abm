...
const errorImage = "/abm/Icons/Text/exclamationpoint.png";
...
function createStatusEffectTooltip(effectData, handlerType = "status") {
    ...
    image.setAttribute("src", "/abm/Icons/UnitIcons/" + effectData.icon + ".png");
    ...
    for (let i = 0; i < list.length; i++) {
        ...
        switch (cardType) {
            case "unitTomeIcon":
                ...
                btn.innerHTML =
                    '<img style="float:left;" src="/abm/Icons/TomeIcons/' +
                    lookUpTome.icon +
                    ".png\" width='25px'\">" +
...
function addUnitTypeIcon(a, holder, origin) {
    ...
    imag.setAttribute("src", "/abm/Icons/UnitIcons/" + iconsrc + ".png");
    imag.setAttribute("onerror", "this.setAttribute('src','" + errorImage + "')");
    imag.setAttribute("width", "40");
    imag.setAttribute("height", "40");

    spa.innerHTML =
        '<img style="float:left; height:30px; width:30px" src="/abm/Icons/UnitIcons/' +
        iconsrc +
    ...
    if (origin !== "") {
        ...
        if (roleNames.includes(iconName)) {
            ...
            unitRole.setAttribute("src", `/abm/Icons/Text/${clearname}.png`);
        }
    }
...
function addAbilityslot(a, holder, list, enchant, uniqueMedal) {
                        ...
                        if ("type2" in jsonEnchantments[k].attack[t]) {
                            if (jsonEnchantments[k].attack[t].type2.indexOf("*") != -1) {
                                if (
                                    ...
                                    abilityEncht +=
                                        '<bullet><img src="/abm/Icons/SpellIcons/' +
    ...
    let abilityIconType = "";
    imag.setAttribute("src", "/abm/Icons/UnitIcons/" + abilityIcon + ".png");

    abilityIconType = GetAbilityBackground(abilityDam);

    imag.setAttribute(
        "style",
        'background-image: url("/abm/Icons/Interface/' +
            abilityIconType +
    ...
    if (Cooldown != "") {
        ...
        imageExtra.setAttribute("src", "/abm/Icons/Text/turn.png");
    ...
    if (Once != "") {
        imageExtra = document.createElement("IMG");
        imageExtra.setAttribute("src", "/abm/Icons/Text/once.png");
        imageExtra.setAttribute("style", " position: absolute; height: 18px; left: 0px;bottom: 4px;");
        btn.append(imageExtra);
    }
    ...
    if (Melee != "") {
        imageExtra = document.createElement("IMG");
        imageExtra.setAttribute("src", "/abm/Icons/Text/armor_small.png");
    ...
    if (Magic != "") {
        imageExtra = document.createElement("IMG");
        imageExtra.setAttribute("src", "/abm/Icons/Text/resistance_small.png");
...
function GetAbilityToolTip(ability, uniqueMedal) {
    ...
    abilityIcon.setAttribute("src", "/abm/Icons/UnitIcons/" + ability.icon + ".png");
    abilityIcon.style.backgroundImage = "url(/abm/Icons/Interface/" + abilityBackground + ".png";
...
function addUniquePassiveSlot(enchantment, descr, div, overwrite) {
    ...
    imag.setAttribute("src", "/abm/Icons/SpellIcons/" + abilityIcon + ".png");
    imag.setAttribute("onerror", "this.setAttribute('src','" + errorImage + "')");
    imag.setAttribute("width", "40");
    imag.setAttribute("height", "40");
...
function CreatePassiveSlotToolTip(abilityIcon, abilityName, abilityDescr) {
    ...
    spa.innerHTML =
        '<div class="abilityHighLighter"><img style="float:left; position:relative; top:-7px; height:30px; width:30px" src="/abm/Icons/UnitIcons/' +
        abilityIcon +
    ...
    for (let j = 0; j < jsonUnitAbilities.length; j++) {
        if (a === jsonUnitAbilities[j].slug) {
            ...
            if (a.indexOf("Frost") !== -1) {
                imag.setAttribute("src", "/abm/Icons/Text/frost_resistance.png");
                spa.innerHTML += "<defensefrost></defensefrost>";
            }
            if (a.indexOf("Blight") !== -1) {
                imag.setAttribute("src", "/abm/Icons/Text/blight_resistance.png");
                spa.innerHTML += "<defenseblight></defenseblight>";
            }
            if (a.indexOf("Physical") !== -1) {
                imag.setAttribute("src", "/abm/Icons/Text/physical_resistance.png");
                spa.innerHTML += "<defensephysical></defensephysical>";
            }
            if (a.indexOf("Fire") !== -1) {
                imag.setAttribute("src", "/abm/Icons/Text/fire_resistance.png");
                spa.innerHTML += "<defensefire></defensefire>";
            }
            if (a.indexOf("Spirit") !== -1) {
                imag.setAttribute("src", "/abm/Icons/Text/spirit_resistance.png");
                spa.innerHTML += "<defensespirit></defensespirit>";
            }

            if (a.indexOf("Shock") !== -1) {
                imag.setAttribute("src", "/abm/Icons/Text/lightning_resistance.png");
...
function addstatusResistanceSlot(a, holder) {
    ...
    imag.setAttribute("src", "/abm/Icons/Text/status_resistance.png");
...
function showUnit(unitID, subcultureCheck, resID, divOrigin) {
    ...
    imagelink.setAttribute("src", "/abm/PreviewsAvif/" + unitEN.id + ".avif");
    if (imagelink.getAttribute("src") === "/abm/PreviewsAvif/undefined") {
        imagelink.setAttribute("src", "/abm/PreviewsAvif/abductor.avif");
    }
    // }
    ...
    if (MountedSpecialList.includes(unitID) || CheckIfOptionalCavalry(unitID)) {
        ...
        imag = document.createElement("IMG");
        imag.setAttribute("src", "/abm/Icons/Text/MountInteraction.png");
    ...
    if ("combat_speed" in unitEN) {
        ...
        img.setAttribute("src", "/abm/Icons/Text/combat_speed.png");
    ...
    if (CheckIfFormUnit(unitEN)) {
        ...
        imag.setAttribute("src", "/abm/Icons/FactionCreation/human.png");

        imag.setAttribute("width", "40");
        imag.setAttribute("height", "40");

        span.innerHTML =
            '<img style="float:left; height:30px; width:30px" src="/abm/Icons/FactionCreation/human.png"><p style="color: #d7c297" class="abilityHighLighter">' +
...
function backtrackUnitOrigins(unitData, name, holder) {
    ...
    if (culture != "thing") {
        ...
        const imgSrc = `/abm/Icons/Text/${culture}.png`;
        const imgFallbackSrc = `/abm/Icons/Text/mp.png`;
        const link = `/abm/HTML/${capitalized}Units.html`;
    ...
    if (subculture != "") {
        ...
        const imgSrc = `/abm/Icons/Text/${subculture}.png`;
        const imgFallbackSrc = `/abm/Icons/Text/mp.png`;
        //  const link = `/abm/HTML/${capitalized}Units.html`;
    ...
    for (let x = 0; x < tomes.length; x++) {
        ...
        const imgSrc = `/abm/Icons/TomeIcons/${tomes[x].icon}.png`;
        const imgFallbackSrc = `/abm/Icons/Text/mp.png`;
        const link = `/abm/HTML/Spells.html?tome=${tomes[x].id}`;
        createFoundUnitInHereIcon(holderOrigin, imgSrc, imgFallbackSrc, link, tooltipText);
    }
    ...
    for (let x = 0; x < spells.length; x++) {
        ...
        if (spells[x].icon != undefined && !incorrectIconOverrideList.includes(spells[x].id)) {
            ...
            imageSRC = "/abm/Icons/SpellIcons/" + imageLinkName + ".png";
        } else {
            imageLinkName = spells[x].id;
            imageSRC = "/abm/Icons/SummonIcons/" + imageLinkName + ".png";
        }
        // let imageLinkName =  spells[x].icon?  spells[x].icon :  spells[x].id;

        // const imgSrc = `/abm/Icons/SpellIcons/${imageLinkName}.png`;
        const imgFallbackSrc = `/abm/Icons/Text/mp.png`;
        const link = `/abm/HTML/Spells.html?spell=${spells[x].id}`;
    ...
    for (let x = 0; x < siege.length; x++) {
        ...
        const imgSrc = `/abm/Icons/SiegeProjectIcons/${siege[x].icon}.png`;
        const imgFallbackSrc = `/abm/Icons/Text/mp.png`;
        const link = `/abm/HTML/Spells.html?siege=${siege[x].id}`;
        createFoundUnitInHereIcon(holderOrigin, imgSrc, imgFallbackSrc, link, tooltipText);
    }
    ...
    for (let x = 0; x < struc.length; x++) {
        ...
        const imgSrc = `/abm/Icons/UpgradeIcons/${struc[x].icon}.png`;
        const imgFallbackSrc = `/abm/Icons/Text/mp.png`;
        const link = `/abm/HTML/Spells.html?structure=${struc[x].id}`;
        const miniIcon = document.createElement("div");
        miniIcon.className = "MiniIconCheck";
    ...
    for (let x = 0; x < traitFound.length; x++) {
        ...
        const imgSrc = `/abm/Icons/FactionCreation/${traitFound[x].id}.png`;
        const imgFallbackSrc = `/abm/Icons/Text/mp.png`;
        const link = `/abm/HTML/Spells.html?trait=${traitFound[x].id}`;
        createFoundUnitInHereIcon(holderOrigin, imgSrc, imgFallbackSrc, link, tooltipText);
    }
    ...
    for (let x = 0; x < wonder.length; x++) {
        ...
        const imgSrc = `/abm/Icons/StructurePics/${wonder[x].id}.png`;
        const imgFallbackSrc = `/abm/Icons/Text/mp.png`;
        const link = `/abm/HTML/Spells.html?wonder=${wonder[x].id}`;
    ...
    for (let x = 0; x < tree.length; x++) {
        ...
        const imgSrc = `/abm/Icons/EmpireProgressionIcons/${tree[x].icon}.png`;
        const imgFallbackSrc = `/abm/Icons/Text/mp.png`;
        const link = `/abm/HTML/EmpireTree.html`;
        createFoundUnitInHereIcon(holderOrigin, imgSrc, imgFallbackSrc, link, tooltipText);
    }
    ...
    for (let x = 0; x < unitAbility.length; x++) {
        ...
        const imgSrc =
            unitAbility[0] != ""
                ? `/abm/Icons/UnitIcons/${unitAbility[x][1].icon}.png`
                : `/abm/Icons/UnitIcons/${unitAbility[x][1].icon}.png`;
        const imgFallbackSrc = `/abm/Icons/Text/mp.png`;
        const link = `/abm/HTML/Units.html?unit=${unitAbility[x][0].id}`;
        createFoundUnitInHereIcon(holderOrigin, imgSrc, imgFallbackSrc, link, tooltipText);
    }
    ...
    for (let x = 0; x < infusion.length; x++) {
        ...
        const imgSrc = `/abm/Icons/UpgradeIcons/0000045E00000EC3.png`;
        const imgFallbackSrc = `/abm/Icons/Text/mp.png`;
        const link = `#`;
        createFoundUnitInHereIcon(holderOrigin, imgSrc, imgFallbackSrc, link, tooltipText);
    }*/
    ...
    for (let x = 0; x < heroSkill.length; x++) {
        ...
        const imgSrc =
            heroSkill[x][0] != ""
                ? `/abm/Icons/UnitIcons/${heroSkill[x][0].icon}.png`
                : `/abm/Icons/UnitIcons/${heroSkill[x][1].icon}.png`;
        const imgFallbackSrc = `/abm/Icons/Text/mp.png`;
        const link = `/abm/HTML/Spells.html?skill=${heroSkill[x][1].id}`;
        createFoundUnitInHereIcon(holderOrigin, imgSrc, imgFallbackSrc, link, tooltipText);
    }
    ...
    for (let x = 0; x < governance.length; x++) {
        ...
        const imgSrc = `/abm/Icons/GovernanceIcons/${governance[x].icon}.png`;
        const imgFallbackSrc = `/abm/Icons/Text/mp.png`;
        const link = `/abm/HTML/Spells.html?governance=${governance[x].id}`;
        createFoundUnitInHereIcon(holderOrigin, imgSrc, imgFallbackSrc, link, tooltipText);
    }
    ...
    if (evolve != "") {
        ...
        const imgSrc = `/abm/Icons/Text/evolve.png`;
        const imgFallbackSrc = `/abm/Icons/Text/mp.png`;
        const link = `/abm/HTML/Units.html?unit=${evolve.id}`;
        createFoundUnitInHereIcon(holderOrigin, imgSrc, imgFallbackSrc, link, tooltipText);
    }
    ...
    if (freecity.length > 0) {
        ...
        const imgSrc = `/abm/Icons/Text/free_city.png`;
        const imgFallbackSrc = `/abm/Icons/Text/mp.png`;
        const link = `/abm/HTML/FreeCities.html`;
        const miniIcon = document.createElement("div");
        miniIcon.className = "MiniIconCheck";
        miniIcon.innerHTML = "<rally></rally>";
...
function addLevelUpInfo(units, a, holder) {
    ...
    if (evolveTarget) {
        const levelText = `<bullet> Evolves/Promotes into <hyperlink><a href="/abm/HTML/Units.html?unit=${evolveTarget}" target="_blank">${lookupUnit(evolveTarget)}</a></hyperlink></bullet>`;
...
function showSiegeProject(id, showOrigin, divOrigin) {
    ...
    if (siegeProject != undefined) {
        ...
        imagelink.setAttribute("src", "/abm/Icons/SiegeProjectIcons/" + siegeProject.icon + ".png");
...
function showExtraTomeSkill(skill, showOrigin, divOrigin) {
    ...
    imagelink.setAttribute("src", "/abm/Icons/SpellIcons/" + imageLinkName + ".png");
...
function showEmpireUpgrade(skill, showOrigin, divOrigin) {
    ...
    let imageLinkName = skill.name.replaceAll(" ", "_").toLowerCase();
    imagelink.setAttribute("src", "/abm/Icons/ExtraIcons/" + imageLinkName + ".png");
...
function showTome(a, divOrigin) {
    ...
    imagelink.setAttribute("src", "/abm/Icons/TomeIcons/" + tomeEN.icon + ".png");
...
function createTooltipForEnchant(item) {
    ...
    image.setAttribute("src", "/abm/Icons/SpellIcons/" + item.icon + ".png");
...
function SetEnchantment(evt) {
    if (!isInArray(evt.currentTarget.activeEnchantList, evt.currentTarget.enchant)) {
        ...
        image.setAttribute("src", "/abm/Icons/SpellIcons/" + evt.currentTarget.enchant.icon + ".png");
...
function showStructure(a, showOrigin, divOrigin) {
    ...
    imagelink.setAttribute("src", "/abm/Icons/UpgradeIcons/" + structureLoc.icon + ".png");
...
function addUnlockableUnitsToStructure(a, keyword, unitList, descriptionDiv, unitTypesDiv) {
    if (a.indexOf(keyword) !== -1) {
        ...
        for (let i = 0; i < unitList.length; i++) {
            ...
            div.innerHTML =
                "<bullet>" +
                '<a href="/abm/HTML/Units.html?unit=' +
                unitList[i] +
                '" target="_blank">' +
...
function showCosmicHappening(a, divOrigin) {
    ...
    for (j in jsonCosmicHappenings) {
        if (a === jsonCosmicHappenings[j].id) {
            ...
            imagelink.setAttribute("src", "/abm/Icons/CosmicHappenings/category_icon_" + categoryLink + ".png");
            ...
            preview.setAttribute("style", 'background-image: url("/abm/Icons/CosmicHappenings/' + imagePos);

            preview.setAttribute("src", "/abm/Icons/Interface/Runecircle.png");
...
function showWorldStructure(a, divOrigin) {
    ...
    if (structure.type.indexOf("wonder") != -1) {
        ...
        imagelink.setAttribute("src", "/abm/Icons/Text/landmark.png");

        imagelink.setAttribute("style", "background-image: none");
    } else if (structure.type == "Spawner") {
        imagelink.setAttribute("src", "/abm/Icons/Interface/Header/Infestation.png");
        imagelink.setAttribute("style", "background-image: none");
    } else {
        imagelink.setAttribute("src", "/abm/Icons/WorldStructures/" + a + ".png");
    ...
    let preview = divOrigin.querySelector("#structurepreview");
    preview.setAttribute("src", "/abm/Icons/StructurePics/" + a + ".png");
...
function showInfusionListEntrySmall(infusion, selectedTreeFilter, selectedSubTreeFilter, selectedMMTreeFilter) {
    ...
    icon.setAttribute("src", "/abm/Icons/UnitIcons/" + infusion.icon + ".png");
    ...
    for (const entry of weapons) {
        ...
        const img = document.createElement("img");
        img.setAttribute("src", "/abm/Icons/ItemForge/" + entry.toLowerCase() + ".png");
...
function FindCombatEnchantment(combatID) {
    ...
    let div = document.createElement("DIV");
    div.innerHTML =
        '<img style="float:left; height:80px; padding:10px" src="/abm/Icons/CombatEnchantments/' +
...
function showDestinyTrait(trait, divOrigin) {
    ...
    if (traitEN != undefined) {
        ...
        imagelink.setAttribute("src", "/abm/Icons/EmpireProgressionIcons/" + traitEN.id + ".png");
...
function showEmpireTree(a, divOrigin) {
    ...
    for (j in jsonEmpire) {
        if (a === jsonEmpire[j].id) {
            ...
            imagelink.setAttribute("src", "/abm/Icons/EmpireProgressionIcons/" + jsonEmpire[j].icon + ".png");
...
function showUnitUnlock(a, divOrigin) {
    ...
    imagelink.setAttribute("src", "/abm/Icons/UnitUnlockIcons/" + a.unit_slug + ".png");
...
function showItem(itemLoc, divOrigin) {
    ...
    tomeOriginIcon.setAttribute("src", "/abm/Icons/UnitIcons/" + itemLoc.icon + ".png");
}
...
function showTraitSetup(currentTrait, divOrigin, loc) {
    ...
    if ("extraLookup" in currentTrait || iconLink == undefined) {
        ...
        imagelink.setAttribute("src", "/abm/Icons/FactionCreation/" + iconLink + ".png");
    } else {
        if (iconLink.startsWith("_")) {
            iconLink = iconLink.split("_").slice(1).join("_");
        }
        imagelink.setAttribute("src", "/abm/Icons/TraitIcons/" + iconLink + ".png");
    }
    ...
    for (const entry of thisFreeCityPart) {
        ...
        if ("enchantments" in entry) {
            ...
            for (const unit of entries) {
                ...
                div.setAttribute("style", "margin-right: 20px;");
                div.innerHTML =
                    '<a href="/abm/HTML/Spells.html?spell=' +
                    unit +
                    '" target="_blank">' +
        ...
        if ("buildings" in entry) {
            ...
            for (const unit of entries) {
                ...
                div.setAttribute("style", "margin-right: 20px;");
                div.innerHTML =
                    '<a href="/abm/HTML/Spells.html?structure=' +
                    unit +
                    '" target="_blank">' +
...
function showHeroTrait(a, divOrigin) {
    ...
    let imagelink = divOrigin.querySelector("#modicon");
    imagelink.setAttribute("src", "/abm/Icons/AmbitionIcons/" + thisAmbition.icon + ".png");
    imagelink.setAttribute("style", "background-image:none");
...
function showHeroGov(data, check, divOrigin) {
    ...
    let imagelink = divOrigin.querySelector("#modicon");
    imagelink.setAttribute("src", "/abm/Icons/GovernanceIcons/" + thisGovernance.icon + ".png");
    imagelink.setAttribute("style", "background-image:none");
    found = true;
}
...
function showSkill(a, checkInAbilities, icon_slug, category, level, group_name, divOrigin) {
    ...
    if (a.type === "signature") {
        ...
        imagelink.setAttribute("src", "/abm/Icons/UnitIcons/" + icon_slug + ".png");
...
function backtraceTomeOriginAndTier(spell, showorigin, modCard) {
    ...
    if (tomespells != undefined) {
        if (showorigin) {
            ...
            tomeOriginIcon.setAttribute("src", "/abm/Icons/TomeIcons/" + tomespells.icon + ".png");
            const wrap = tomeOriginName.innerHTML;
            tomeOriginName.innerHTML =
                '<a href="/abm/HTML/Spells.html?tome=' + tomespells.id + '" target="_blank">' + wrap + "</a>";
