...
const dlcMap = {
    DRAGONLORDS: {
        src: "/abm/Icons/Text/DragonDawn.png",
        text: "Part of the Dragon Dawn DLC"
    },
    EMPIRESANDASHES: {
        src: "/abm/Icons/Text/EmpiresAshes.png",
        text: "Part of the Empires & Ashes DLC"
    },
    PRIMALFURY: {
        src: "/abm/Icons/Text/PrimalFury.png",
        text: "Part of the Primal Fury DLC"
    },
    ELDRITCHREALMS: {
        src: "/abm/Icons/Text/EldritchRealms.png",
        text: "Part of the Eldritch Realms DLC"
    },
    HERALDOFGLORY: {
        src: "/abm/Icons/Text/herald_of_glory.png",
        text: "Part of the Herald of Glory DLC"
    },
    WAYSOFWAR: {
        src: "/abm/Icons/Text/waysofwar.png",
        text: "Part of the Ways of War DLC"
    },
    GIANTKINGS: {
        src: "/abm/Icons/Text/GKLogo.png",
        text: "Part of the Giant Kings DLC"
    },
    ARCHONPROPHECY: {
        src: "/abm/Icons/Text/ArchonProphecy.png",
        text: "Part of the Archon Prophecy DLC"
    },
    COSMICWANDERER: {
        src: "/abm/Icons/Text/CosmicWanderer.png",
        text: "Part of the Cosmic Wanderer DLC"
    },
    THRONESOFBLOOD: {
        src: "/abm/Icons/Text/ThronesOfBlood.png",
        text: "Part of the Thrones of Blood DLC"
    }, RISEFROMRUIN: {
        src: "/abm/Icons/Text/RiseFromRuin.png",
        text: "Part of the Rise From Ruin DLC"
    }
};

async function GetAllData(selectedLang) {
    let basePathEN = `/abm/Data/EN/`;

    /*if (selectedLang == "BETA") {
        basePathEN = `/abm/Data/BETA/`;
    }
    */

    const basePathGen = `/abm/Data/GEN/`;
    // }
    //  const basePathEN = `/abm/Data/EN/`;
    const basePathLocal = `/abm/Data/${selectedLang}/`;
    ...
    try {
        // English only - use EN for both base and localized
        const [dataGen, dataEN, templatesHtml] = await Promise.all([
            fetchJsonFiles(filesToFetchGeneric),
            fetchJsonFiles(filesToFetchEN),
            fetch("/abm/HTML/templates.html").then((res) => res.text())
        ]);
        const dataLocal = dataEN;
...
async function CheckData() {
   ...
   // showBetaTooltip = document.getElementById("showBetaCheckbox");
        ...
        await GetAllData("EN"); // English only
      //  }
